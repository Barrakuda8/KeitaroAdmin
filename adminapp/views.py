...
@user_passes_test(lambda u: u.is_authenticated and (u.is_superuser or u.buyer_id) and not u.is_deleted)
def stats(request):
...
class AccessMixin:
    ...
    @method_decorator(user_passes_test(lambda u: u.is_authenticated and (u.is_superuser or u.support_id or u.buyer_id)
